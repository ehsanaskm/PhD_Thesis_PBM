...
void qmom::updateSauterDiameter()
{
   ...
   Info << nl << "           min/avg/max moment 0: " << min(m0).value()
              << "/" << average(m0).value()<< "/" << max(m0).value() << endl;
   Info << nl << "           min/avg/max moment 1: " << min(m1).value()
              << "/" << average(m1).value()<< "/" << max(m1).value() << endl;
   Info << nl << "           min/avg/max moment 2: " << min(m2).value()
              << "/" << average(m2).value()<< "/" << max(m2).value() << endl;
   Info << nl << "           min/avg/max moment 3: " << min(m3).value()
              << "/" << average(m3).value()<< "/" << max(m3).value() << endl;
   Info << nl << "           min/avg/max moment 4: " << min(m4).value()
              << "/" << average(m4).value()<< "/" << max(m4).value() << endl;
   Info << nl << "           min/avg/max moment 5: " << min(m5).value()
